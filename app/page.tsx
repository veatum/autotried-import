...
export default function Home() {
 ...
 <a className="brand" href="#" aria-label="AutoTried — на главную"><span className="brand-mark" aria-hidden="true">A↗</span><span>AUTO<span className="brand-light">TRIED</span><small>INTERNATIONAL AUTO IMPORT</small></span></a>
